...
class accelerator {
	...
	void                accelerate_x(motion_vector&, double);
	void                accelerate_y(motion_vector&, double);
	void                accelerate(motion_vector&, double);
	...
	void                decelerate_x(motion_vector&, double);
	void                decelerate_y(motion_vector&, double);
	void                decelerate(motion_vector&, double);
	void                decelerate(motion_vector&, const motion_vector&);

	private:

	void                away_from_zero(double&, double, double);
	void                towards_zero(double&, double, double);
