...
class mover {
    ...
    */
	void        apply_and_commit(d2d::collision::spatiable&, const d2d::motion::motion_vector&, ldtools::tdelta) const;
	void        apply_and_commit(d2d::collision::spatiable&, ldtools::tdelta) const;
};
}}
