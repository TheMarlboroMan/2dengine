...
//Begin implementation of spatiable
	...
	virtual t_position                      get_x() const {return collision_box.origin.x;}
	virtual t_position                      get_y() const {return collision_box.origin.y;}
	virtual t_size                          get_w() const {return collision_box.w;}
	virtual t_size                          get_h() const {return collision_box.h;}
